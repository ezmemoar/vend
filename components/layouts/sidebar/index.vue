<template>
  <aside
    class="absolute left-0 top-0 z-9999 flex h-screen flex-col overflow-y-hidden bg-primary duration-300 ease-linear lg:static lg:translate-x-0 gap-5 py-8 px-5"
    :class="{
